...
public class SignInPage extends BaseClass{
	...
	public SignInPage() {
		...
		try {
			FileInputStream configFile = new FileInputStream("C:\\Users\\Danish\\eclipse-workspace\\AutomationExcercise\\src\\main\\java\\com\\automationexercise\\config\\config.properties");
